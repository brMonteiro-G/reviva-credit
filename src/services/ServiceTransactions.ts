...
export async function serviceTransactions(setTransactions: Dispatch<SetStateAction<ITransaction[]>>):Promise<void> {
...
function dateHandler(data: ITransaction[]):ITransaction[] {
